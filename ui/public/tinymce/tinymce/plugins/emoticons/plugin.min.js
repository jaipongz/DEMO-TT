...
(function (domGlobals) {
    ...
    var open = function (editor, database) {
      ...
      var scan = function (dialogApi) {
        // $(".tox-form__group").not(".tox-form__group--collection").wrap("<div class='row-data style-form2'></div>");
        // $(".tox-form__group").addClass("input-template2");
        // $(".tox-form__group .tox-label").addClass("placeholder");
        // $(".tox-form__group .tox-label").each(function(){
        //   var idfor = $(this).attr("for");
        //   $(".tox-label.placeholder[for="+idfor+"]").insertAfter("#"+idfor);
        // });
        // $(".tox-form__group .tox-selectfield select").each(function(){
        //     $(this).parents(".style-form2").addClass("dropdown");
        //     $(this).parents(".style-form2").find(".tox-label.placeholder").hide();
        //     $(this).selectBoxIt();
        // });
        // initFocusInput();
